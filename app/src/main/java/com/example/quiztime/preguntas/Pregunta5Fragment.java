 ...
 * Use the {@link Pregunta5Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Pregunta5Fragment extends Fragment {
     ...
     * @return A new instance of fragment Pregunta5Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Pregunta5Fragment newInstance(String param1, String param2) {
        Pregunta5Fragment fragment = new Pregunta5Fragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button opcion1 = view.findViewById(R.id.button_prg5_opcion1);
        Button opcion2 = view.findViewById(R.id.button_prg5_opcion2);
        Button opcion3 = view.findViewById(R.id.button_prg5_opcion3);
        Button opcion4 = view.findViewById(R.id.button_prg5_opcion4);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gestionPuntuacion.verResultados(view);
            }
        });
    }
