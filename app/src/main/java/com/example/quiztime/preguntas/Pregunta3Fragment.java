 ...
 * Use the {@link Pregunta3Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Pregunta3Fragment extends Fragment {
    ...
    public static Pregunta3Fragment newInstance(String param1, String param2) {
        Pregunta3Fragment fragment = new Pregunta3Fragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button opcion1 = view.findViewById(R.id.button_prg3_opcion1);
        Button opcion2 = view.findViewById(R.id.button_prg3_opcion2);
        Button opcion3 = view.findViewById(R.id.button_prg3_opcion3);
        Button opcion4 = view.findViewById(R.id.button_prg3_opcion4);
        ...
        opcion1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                comprobarRespuesta(opcion1, opcion2, siguiente);
        ...
        opcion2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                comprobarRespuesta(opcion2, opcion2, siguiente);
                opcion1.setEnabled(false);
                opcion2.setEnabled(false);
                opcion3.setEnabled(false);
                opcion4.setEnabled(false);
        ...
        opcion3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                comprobarRespuesta(opcion3, opcion2, siguiente);
                opcion1.setEnabled(false);
                opcion2.setEnabled(false);
                opcion3.setEnabled(false);
                opcion4.setEnabled(false);
        ...
        opcion4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                comprobarRespuesta(opcion4, opcion2, siguiente);
                opcion1.setEnabled(false);
                opcion2.setEnabled(false);
                opcion3.setEnabled(false);
                opcion4.setEnabled(false);
        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.pregunta4Fragment);
            }
        });
    }
